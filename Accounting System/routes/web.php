...
Route::middleware(['auth', 'role:Accounting Administrator,Cashier,Accounting Staff'])->group(function (): void {
    ...
    Route::get('students/{student}/statement-of-account', [StatementOfAccountController::class, 'show'])->name('statements.show');
    Route::get('students/{student}/statement-of-account/download', [StatementOfAccountController::class, 'download'])->name('statements.download');

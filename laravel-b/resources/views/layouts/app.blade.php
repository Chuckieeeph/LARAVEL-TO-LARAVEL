    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('fee-schedules.index') }}">Fee Schedules</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('assessments.index') }}">Assessments</a></li>
